#!/usr/bin/env python3
"""
KOBRA v4.2.0 MCP server — exposes FULL KOBRA suite as MCP tools over stdio.
Supports ALL v4.2.0 features + v4.1.0 suites: nuclei compat, IDOR, tech fingerprint, SARIF,
